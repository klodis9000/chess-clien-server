...
namespace Chess
{
    class FigureMoving
    {
        ...
        public Square from { get; private set; } //откуда идёт
        public Square to { get; private set; } //куда идёт
        public Figure promotion { get; private set; } //в кого превратилась пешка

        public FigureMoving(FigureOnSquare fs,Square to,Figure promotion = Figure.none)
        {
            this.figure = fs.figure;
            this.from = fs.square; //откуда фигура пришла
            this.to = to;
            this.promotion = promotion;

        }

        public FigureMoving(string move) //ход в текстовом формате Pe2e4    Pe7e8Q
        {                                                        //01234    012345
